...
describe('TemplateResult', () => {
  ...
  describe('attributes', () => {
    it('should process a template with quoted attribute value', () => {
      ...
      expect(readTemplateResult(result).toString()).to.equal('<div a="text"></div>');
    });
    ...
    it('should process a template with quoted attribute value and extra strings', () => {
      ...
      expect(readTemplateResult(result).toString()).to.equal('<div a="some text"></div>');
    });
    it('should process a template with quoted attribute and multiple strings/values', () => {
      ...
      expect(readTemplateResult(result).toString()).to.equal('<div a="this is some text">node</div>');
    });
    it('should process a template with boolean attribute value', () => {
      const value = true;
      const result = h`<div ?a="${value}"></div>`;
      expect(readTemplateResult(result).toString()).to.equal('<div a></div>');
    });
    it('should process a template with event attribute value', () => {
      const result = h`<div @a="${'some event'}"></div>`;
      expect(readTemplateResult(result).toString()).to.equal('<div ></div>');
    });
    ...
    it('should not process a template with nested template attribute value', () => {
      ...
      expect(readTemplateResult(result).toString()).to.equal('<div a="some [object Object]"></div>');
    });
