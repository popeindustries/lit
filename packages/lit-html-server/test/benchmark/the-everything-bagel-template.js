  ...
  return html`
    <body>
      ...
      <main>
        ...
        <p>
          Duis eleifend nec lectus a ${data.number}. Suspendisse placerat mollis porta. Pellentesque nec quam non sapien
          facilisis ultricies quis nec risus. Quisque feugiat dui quis lectus iaculis, molestie pretium augue tincidunt.
          Suspendisse potenti. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis
          egestas. Suspendisse quis libero sagittis, vulputate magna in, laoreet sem. Ut elementum nunc eget libero
          hendrerit eleifend at eget sem. Sed vel urna consequat, interdum massa in, mollis justo. Pellentesque
        ...
        <p>
          ...
          Proin ${JSON.stringify(data)} laoreet nisi a vulputate. Praesent non congue quam, ut sodales risus. Curabitur
          ornare elit at suscipit pulvinar. Suspendisse vitae orci a justo laoreet vestibulum quis et ex. Integer nec
          risus aliquam, convallis erat in, dignissim sapien. Suspendisse metus felis, volutpat a tempus ut, semper in
          tortor. Mauris rutrum dui in elit blandit, non vestibulum felis cursus. Sed mollis consectetur eros a
